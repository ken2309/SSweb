...
namespace SSWeb.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(SSWebContext context)
        {
            _context = context;
        }
        ...
        {
            var sSWebContext = _context.Carts.Include(c => c.Customer).Include(c => c.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,CustomerId,Quantity")] Cart cart)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customers, "Id", "Username", cart.CustomerId);
